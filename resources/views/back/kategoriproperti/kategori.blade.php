...
@section('title')
  STATUS PROPERTI | DASHBOARD GOOPRO
@endsection
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">STATUS PROPERTI </h2>
...
<div class="row">
    ...
    <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Status Properti Table <span class="cardright" style="float:right"><a href="{{route('statusproperti.create')}}">New</a></span></h5>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group ml-auto">
                                                        <a href="{{route('statusproperti.edit',$list->id_kategori)}}" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                                                        <form method="POST" action="{{route('statusproperti.destroy',$list->id_kategori)}}">
                                                        @csrf
                                                        @method('delete')
