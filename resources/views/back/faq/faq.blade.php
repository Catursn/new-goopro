...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="row">     
            <div class="col-12">
            <form class="form-horizontal" data-toggle="validator" method="POST" action="{{route('faq.update',$faq->id_faq)}}" enctype="multipart/form-data" >
            {{ csrf_field() }} {{ method_field('PATCH') }}
                <div class="card">
                    ...
                    <div class="card-body">
                        <textarea id="summernote" name="faq" required>{{$faq->faq}}</textarea>
                    </div>
