...
@section('title')
  ADD TESTIMONI | DASHBOARD GOOPRO
@endsection
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Add Testimoni </h2>
        ...
        <form method="POST"action="{{route('testimoni.store')}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input id="inputText3" type="text" class="form-control" name="nama" required>
                </div>
                <div class="form-group">
                    <label for="inputText3" class="col-form-label">Umur <span class="text-danger">*</span></label>
                    <input id="inputText3" type="number" class="form-control" name="umur" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea id="summernote" name="testimoni" required></textarea>
                </div>
                <div class="form-group">
