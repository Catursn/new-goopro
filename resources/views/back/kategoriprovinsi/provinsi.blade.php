...
@section('title')
  KATEGORI PROVINSI | DASHBOARD GOOPRO
@endsection
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">KATEGORI PROVINSI </h2>
...
<div class="row">
    ...
    <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Kategori Provinsi Table <span class="cardright" style="float:right"><a href="{{route('kategoriprovinsi.create')}}">New</a></span></h5>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group ml-auto">
                                                        <a href="{{route('kategoriprovinsi.edit',$list->id_provinsi)}}" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                                                        <form method="POST" action="{{route('kategoriprovinsi.destroy',$list->id_provinsi)}}">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="btn btn-sm btn-danger" data-id={{$list->id_provinsi}} data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return confirm('Anda yakin mau menghapus item ini ?')"><i class="far fa-trash-alt"></i></button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
