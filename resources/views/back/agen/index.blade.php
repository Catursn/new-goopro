...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">AGEN </h2>
            <!-- <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p> -->
            <div class="page-breadcrumb">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Agen</a></li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="row">
    ...
    <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Agen Table</h5>
                            <div class="card-body">
                                        ...
                                        @foreach($user as $ber)
                                            <tr>
                                                ...
                                                <div class="btn-group ml-auto">
                                                    <a href="{{route('agen.show',$ber->id)}}" class="btn btn-sm btn-info" title="Show"><i class="fas fa-eye"></i></a>
                                                </div>
                                                </td>
                                            </tr>
                                        @endforeach  
