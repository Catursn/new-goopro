...
@section('title')
  KATEGORI BERITA | DASHBOARD GOOPRO
@endsection
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">KATEGORI BERITA </h2>
...
<div class="row">
    ...
    <div class="row">
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <h5 class="card-header">Kategori Berita Table <span class="cardright" style="float:right"><a href="{{route('kategoriberita.create')}}">New</a></span></h5>
                            <div class="card-body">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group ml-auto">
                                                        <a href="{{route('kategoriberita.edit',$list->id_kategori)}}" class="btn btn-sm btn-outline-light" title="Edit"><i class="fas fa-edit"></i></a>
                                                        <form method="POST" action="{{route('kategoriberita.destroy',$list->id_kategori)}}">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="btn btn-sm btn-outline-light dltBtn" data-id={{$list->id_kategor}} style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" data-placement="bottom" title="Delete"><i class="far fa-trash-alt"></i></button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
