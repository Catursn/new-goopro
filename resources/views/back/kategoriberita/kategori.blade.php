                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group ml-auto">
                                                        <a href="{{route('kategoriberita.edit',$list->id_kategori)}}" class="btn btn-sm btn-info" title="Edit"><i class="fas fa-edit"></i></a>
                                                        <form method="POST" action="{{route('kategoriberita.destroy',$list->id_kategori)}}">
                                                        @csrf
                                                        @method('delete')
                                                        <button class="btn btn-sm btn-dangers" data-id={{$list->id_kategor}} data-toggle="tooltip" data-placement="bottom" title="Delete" onclick="return confirm('Anda yakin mau menghapus item ini ?')"><i class="far fa-trash-alt"></i></button>
                                                        </form>
                                                    </div>
                                                </td>
                                            </tr>
