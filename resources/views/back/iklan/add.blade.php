...
@section('title')
  ADD IKLANKAN PROPERTY | DASHBOARD GOOPRO
@endsection
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="page-header">
            <h2 class="pageheader-title">Jenis properti apa yang ingin Anda tawarkan?</h2>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="jenis" class="custom-control-input" value="jual"><span class="custom-control-label">Jual</span>
                            </label>
                            <label class="custom-control custom-radio custom-control-inline">
                                <input type="radio" name="jenis" class="custom-control-input" value="sewa"><span class="custom-control-label">Sewa</span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="tipe">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="sitaan">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="summernote" name="deskripsi"></textarea><br>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="harga">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="sejak">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="objek">
                        </div>
                    </div>
                </div>  
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputText3" type="text" class="form-control" name="youtube">
                    </div>
                    <div class="form-group">
                        <label for="inputText3" class="col-form-label">Tempelkan URL virtual tour</label>
                        <input id="inputText3" type="text" class="form-control" name="virtual">
                    </div>
                </div>  
            </div>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="area">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="alamatproperti" placeholder="Masukkan nama jalan dan nomor jalan">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="alamat" placeholder="Masukkan nama jalan dan nomor jalan">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="handphone">
                        </div>
                    </div>
                    <div class="form-group row">
                        <div class="col-lg-2 col-md-2 col-sm-12">
                        ...
                        <div class="col-lg-10 col-md-10 col-sm-12">
                            <input id="inputText3" type="text" class="form-control" name="kantor">
                        </div>
                    </div>
                    <div class="form-group">
